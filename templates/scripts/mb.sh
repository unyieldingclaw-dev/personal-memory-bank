...
invoke_init() {
    ...
    echo "$GITIGNORE_CONTENT" | grep -q "\.claude/\.code-review-ok" || GITIGNORE_ADDS+=(".claude/.code-review-ok")
    echo "$GITIGNORE_CONTENT" | grep -q "\.claude/\.change-review-ok" || GITIGNORE_ADDS+=(".claude/.change-review-ok")
    echo "$GITIGNORE_CONTENT" | grep -q "\.claude/\.code-review-ok\.claimed" || GITIGNORE_ADDS+=(".claude/.code-review-ok.claimed*")
    echo "$GITIGNORE_CONTENT" | grep -q "\.claude/\.change-review-ok\.claimed" || GITIGNORE_ADDS+=(".claude/.change-review-ok.claimed*")
    echo "$GITIGNORE_CONTENT" | grep -q "\.claude/\.pending-commit-presha" || GITIGNORE_ADDS+=(".claude/.pending-commit-presha")
    echo "$GITIGNORE_CONTENT" | grep -q "\.claude/\.pending-push-presha" || GITIGNORE_ADDS+=(".claude/.pending-push-presha")
    echo "$GITIGNORE_CONTENT" | grep -q "\.claude/\.pending-commit-hash" || GITIGNORE_ADDS+=(".claude/.pending-commit-hash")
    echo "$GITIGNORE_CONTENT" | grep -q "\.claude/\.pending-push-hash" || GITIGNORE_ADDS+=(".claude/.pending-push-hash")
